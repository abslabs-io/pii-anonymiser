...
export type GeminiNanoModelId = 'gemini-nano';
export type ModelId = WebLlmModelId | TransformersJsModelId | GeminiNanoModelId;
...
export const geminiNanoModels: ModelOption[] = [
  {
    id: 'gemini-nano',
    label: 'Gemini Nano · Chrome managed',
