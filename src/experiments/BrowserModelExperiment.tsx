      ...
      {page === 'workbench' ? (
            ...
            <section className="panel input-panel">
              ...
              <div className="input-footer">
                <span className={tooLong ? 'over-limit' : ''}>
                  {bytes.toLocaleString()} / {MAX_INPUT_BYTES.toLocaleString()}{' '}
                  bytes
                </span>
            ...
            <section className="panel findings">
              <div className="panel-heading">
                ...
                <span className="subtle">
                  {new Set(result.spans.map((span) => span.token)).size} unique
                  tokens
                </span>
              </div>
        ...
        <section className="panel evaluation-panel">
          ...
          <p className="evaluation-description">
            ...
            detection must match both the exact span and its category. This is a
            small diagnostic set, not a general accuracy benchmark.
          </p>
          {activeEvaluation && (
